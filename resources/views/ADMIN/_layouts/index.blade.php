        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('templates/images/logo.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('templates/images/logo-text.png') }}" alt="">
                <img class="brand-title" src="{{ asset('templates/images/logo-text.png') }}" alt="">
            </a>
                                        ...
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3" src="{{ asset('templates/images/avatar/1.png') }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img width="35" src="{{ asset('templates/images/avatar/1.png') }}" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>Lew Shawon</td>
